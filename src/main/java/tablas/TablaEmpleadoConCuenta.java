...
import datos.Conector;
    ...
    public class TablaEmpleadoConCuenta extends JTable {
        ...
        public TablaEmpleadoConCuenta() {

        }

        public TablaEmpleadoConCuenta(String consulta){
        ...
        public JTable verEmpleadoConCuenta(){
